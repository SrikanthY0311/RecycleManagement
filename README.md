...
Overview
The Recycle Management System is a multi-tier web application developed to manage recycling operations, waste tracking, and operational reporting. The system enables structured data management, reporting visibility, and environment-ready deployment configurations.

Developed as part of a Master's academic project (Aug 2024 – Dec 2024).

---

Architecture
- Multi-tier Architecture (Presentation Layer, Business Logic Layer, Data Access Layer)
...
2. Open `RecycleManagement.sln` in Visual Studio
